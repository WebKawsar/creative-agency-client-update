                ...
                <Container>
                    <Grid container>
                        <Grid className={classes.top} item xs={12}>
                            <Link to="/home"><img className={classes.logo} src="https://i.ibb.co/5jBnLZS/logo.png" alt=""/></Link>
                        </Grid>
                    </Grid>
                    <Grid container>
                        <Grid className={classes.bottom} item md={6} xs={12}>
                            <Paper className={classes.paper}>
                                ...
                                <Box onClick={handleGoogleSignIn} className={classes.google}>
                                    <img className={classes.image} src="https://i.ibb.co/pZRs2rR/google.png" alt=""/>
